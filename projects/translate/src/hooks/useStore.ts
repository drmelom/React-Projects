...
export function useStore(){
    const [{fromLanguage,toLanguage,fromText,loading,result},dispatch] = useReducer(reducer,initialState)
    const interterchangeLanguage = () => dispatch({type: 'INTERCHANGE_LANGUAGE'})
